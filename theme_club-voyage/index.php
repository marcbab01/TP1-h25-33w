...
<main>
      <section class="hero">
        <div class="hero__conteneur">
          <img src="assets/img/img-landscape.jpg" alt=""class="hero__image">
      ...
      <section class="gallerie">
        <div class="medaillon">
          <div><img src="assets/img/img_promo1.jpg" alt="" class="medaillon_img"></div>
        ...
        <div class="medaillon">
          <div><img src="assets/img/img_promo2.jpg" alt="" class="medaillon_img"></div>
          <h2 class="medaillon__titre">Destination</h2>
        ...
        <div class="medaillon">
          <div><img src="assets/img/img_promo3.jpg" alt="" class="medaillon_img"></div>
          <h2 class="medaillon__titre">Destination</h2>
